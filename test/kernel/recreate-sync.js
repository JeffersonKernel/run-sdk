    ...
    const state = {
      'jig://84769a5ac4cec62270093648c9978016640aeccb62c11b717313d41a4c74640c_o2': {
        ...
        props: {
          deps: {
            RelayNFT: {
              $jig: 'cdea2c203af755cd9477ca310c61021abaafc135a21d8f93b8ebfc6ca5f95712_o1'
            }
          },
          friends: [
            {
          ...
          location: '_o2',
          metadata: {
            description: '333 Unique Slavettes will squat on-chain forever',
            image: '_o1',
            isCollection: true,
            isEncrypted: true,
            name: 'Slavettes',
            ...
            royalties: [
              {
                address: '1D1NsYsdyDYewyu1V4reSby3rjUy67EPAM',
                royalty: 0.069
              }
            ],
            symbol: 'COL'
          ...
          nonce: 1,
          origin: '_o2',
          owner: '17QAwgcgR8oH4h6GA1ZwSWDtE52nwiWGnu',
          satoshis: 0
        },
        src: 'class COL extends RelayNFT {}',
        version: '04'
      },
      'jig://cdea2c203af755cd9477ca310c61021abaafc135a21d8f93b8ebfc6ca5f95712_o1': {
        kind: 'code',

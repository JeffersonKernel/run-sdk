...
class Run {
  ...
  get stateServerHost () { return this._stateServerHost }
  ...
  set stateServerHost (stateServerHost) {
    ...
    this._kernel._state = parseState(undefined, false, this.blockchain.network, this._api, stateServerHost, this._apiKey)
    hookPlugins(this)
